...
//	uart3_init(230400);
    ...
    uart5_init(115200);
		...
		uart6_init(115200);//ever loss新增，用于发送数据给舵机
    ...
    //定时器12用作舵机的PWM接口
//    TIM12_SERVO_Init(9999,84-1);  //APB1的时钟频率为84M , 频率=84M/((9999+1)*(83+1))=100Hz//..................换为usart6

    //普通小车默认定时器8用作航模接口
    // TIM8_SERVO_Init(9999,168-1);//APB2的时钟频率为168M , 频率=168M/((9999+1)*(167+1))=100Hz//..................换为usart6
...
//    TIM8_Cap_Init(9999,168-1);  //高级定时器TIM8的时钟频率为168M
	...
	Servo_SetPosition(1, center_x1 , 2000);Servo_SetPosition(2, center_y1 , 2000);//新增，回到原点
	//读取Flash数据
	FlashParam_Read();
}
