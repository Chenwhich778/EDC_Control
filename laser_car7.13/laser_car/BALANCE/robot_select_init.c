...
void Robot_Select(void)
{
  ...
  if(Car_Mode>7)Car_Mode=7;
	...
	switch(Car_Mode)
	{
		case Mec_Car:       Robot_Init(MEC_wheelspacing,         MEC_axlespacing,          0,                     HALL_30F, Hall_13, Mecanum_60);            break; //麦克纳姆轮小车
		...
		case Mec_Car_V550:  Robot_Init(V550_MEC_wheelspacing,    V550_MEC_axlespacing,     0,                     HALL_30F, Hall_13, Mecanum_75);            break; //V550-麦轮
		case FourWheel_Car_V550:  Robot_Init(V550_FourMortorWheelSpacing, V550_FourMortorAxlespacing,  0,         HALL_30F, Hall_13, Black_WheelDiameter);   break; //V550-四驱
	}
	...
	switch(Car_Mode)
  {
	 ...
	 case Mec_Car_V550:  CheckPhrase1=8, CheckPhrase2=14; break; //麦克纳姆轮小车
	 case FourWheel_Car_V550:  CheckPhrase1=8, CheckPhrase2=11; break; //四驱车 
  }
}
